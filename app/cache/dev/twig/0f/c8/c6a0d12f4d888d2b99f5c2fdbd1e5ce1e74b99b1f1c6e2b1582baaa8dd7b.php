...
/* RidwanEntityBundle:Opportunities:message.html.twig */
class __TwigTemplate_0fc8c6a0d12f4d888d2b99f5c2fdbd1e5ce1e74b99b1f1c6e2b1582baaa8dd7b extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("opportunities_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 60
        echo $this->env->getExtension('routing')->getPath("opportunities_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "RidwanEntityBundle:Opportunities:message.html.twig";
    }
