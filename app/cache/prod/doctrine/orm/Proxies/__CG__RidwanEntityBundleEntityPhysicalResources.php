 ...
 */
class PhysicalResources extends \Ridwan\EntityBundle\Entity\PhysicalResources implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResources' . "\0" . 'type', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResources' . "\0" . 'description', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResources' . "\0" . 'causes', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResources' . "\0" . 'organizations', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResources' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhysicalResources $proxy) {
