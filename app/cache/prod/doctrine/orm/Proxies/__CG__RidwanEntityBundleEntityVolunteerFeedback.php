 ...
 */
class VolunteerFeedback extends \Ridwan\EntityBundle\Entity\VolunteerFeedback implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'date', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'rating', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'comment', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'recommend', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'joinAgain', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'description', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'id', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'volunteer', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerFeedback' . "\0" . 'organization');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VolunteerFeedback $proxy) {
