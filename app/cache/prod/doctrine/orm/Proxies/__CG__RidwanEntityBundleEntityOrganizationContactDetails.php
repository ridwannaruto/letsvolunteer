 ...
 */
class OrganizationContactDetails extends \Ridwan\EntityBundle\Entity\OrganizationContactDetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'email', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'fax', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'streetNumber', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'street', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'city', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'divisionalSecretary', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'district', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'country', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'province', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'website', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'id', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\OrganizationContactDetails' . "\0" . 'organization');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrganizationContactDetails $proxy) {
