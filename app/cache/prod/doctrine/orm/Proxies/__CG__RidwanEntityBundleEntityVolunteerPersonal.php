 ...
 */
class VolunteerPersonal extends \Ridwan\EntityBundle\Entity\VolunteerPersonal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'preferredName', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'fullName', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'nicORpassport', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'gender', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'dateofbirth', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'nationality', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'category', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'civilStatus', 'id', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\VolunteerPersonal' . "\0" . 'nicPassport', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VolunteerPersonal $proxy) {
    ...
    public function setPreferredName($preferredName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPreferredName', array($preferredName));

        return parent::setPreferredName($preferredName);
    }
    ...
    public function getPreferredName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPreferredName', array());

        return parent::getPreferredName();
    }
    ...
    public function setNicORpassport($nicORpassport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNicORpassport', array($nicORpassport));

        return parent::setNicORpassport($nicORpassport);
    }
    ...
    public function getNicORpassport()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNicORpassport', array());

        return parent::getNicORpassport();
    }
    ...
    public function setCivilStatus($civilStatus)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCivilStatus', array($civilStatus));
    ...
    public function getCivilStatus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCivilStatus', array());
     ...
     * {@inheritDoc}
     */
    public function setNicPassport($nicPassport)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNicPassport', array($nicPassport));

        return parent::setNicPassport($nicPassport);
    }

    /**
     * {@inheritDoc}
     */
    public function getNicPassport()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNicPassport', array());

        return parent::getNicPassport();
    }
