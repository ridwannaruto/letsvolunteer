 ...
 */
class PhysicalResourcesMapping extends \Ridwan\EntityBundle\Entity\PhysicalResourcesMapping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResourcesMapping' . "\0" . 'id', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResourcesMapping' . "\0" . 'resource', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResourcesMapping' . "\0" . 'volunteer', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\PhysicalResourcesMapping' . "\0" . 'organization');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhysicalResourcesMapping $proxy) {
