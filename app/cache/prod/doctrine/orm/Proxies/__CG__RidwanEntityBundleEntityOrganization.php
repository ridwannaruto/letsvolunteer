 ...
 */
class Organization extends \Ridwan\EntityBundle\Entity\Organization implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Organization' . "\0" . 'name', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Organization' . "\0" . 'branch', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Organization' . "\0" . 'type', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Organization' . "\0" . 'registrationNumber', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Organization' . "\0" . 'previousProjects', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setRegistrationNumber($registrationNumber)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRegistrationNumber', array($registrationNumber));
    ...
    public function setPreviousProjects($previousProjects)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPreviousProjects', array($previousProjects));

        return parent::setPreviousProjects($previousProjects);
    }
    ...
    public function getPreviousProjects()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPreviousProjects', array());

        return parent::getPreviousProjects();
    }
