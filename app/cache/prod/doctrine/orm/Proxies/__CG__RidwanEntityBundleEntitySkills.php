 ...
 */
class Skills extends \Ridwan\EntityBundle\Entity\Skills implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Skills' . "\0" . 'skills', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Skills' . "\0" . 'causes', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Skills' . "\0" . 'other', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Skills' . "\0" . 'languages', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Skills' . "\0" . 'id', '' . "\0" . 'Ridwan\\EntityBundle\\Entity\\Skills' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Skills $proxy) {
